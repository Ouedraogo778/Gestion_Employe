            ...
            <div class="col-sm-12">
                <div class="card card-table comman-shadow">
                    <div class="card-header text-center" style="background-color: blue;">
                        <h3 style="font-family:'Times New Roman', Times, serif; font-weight: bold; color:chartreuse; text-shadow: 4px 4px 6px rgba(0, 0, 0, 0.9);">Liste des activités</h3>
                    </div>
                            ...
                            <table id="example1" class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <thead class="student-thread" id="entete">
                                    <tr>
                                        ...
                                        <th style="font-size: 18px; ">Etat coodination</th>
                                        <th style="font-size: 18px; ">Motif rejet coodination</th>
 ...
 -->
                                ...
                                <tbody id="Table">
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td  style="font-size: 16px; color: black;" >
                                        @if($activite->validation_supperieur == "valider")
                                            <a class="badge badge-success" style="font-size: 16px; color: white;">{{ $activite->validation_supperieur }}</a>
                                        @elseif($activite->validation_supperieur == "rejeter")
                                        <a class="badge badge-danger" style="font-size: 16px; color: white;">{{ $activite->validation_supperieur }}</a>
                                        @else
                                        <a class="badge badge-info" style="font-size: 16px; color: black;">{{ $activite->validation_supperieur }}</a>
                                        @endif
                                        </td> -->
                                        ...
                                        <td class="text-end">
                                            <div class="actions" style="display: flex;">
                                                <form action="{{ route('activites.destroy', $activite->id) }}" method="POST" class="actions">

                                                    <a href="{{ route('activites.show', $activite->id) }}" class="btn btn-sm bg-danger-light">
                                                        <i style="font-size: 16px; color: black;" class="fab fa-phabricator"></i>
                                                    </a>

                                                    @can('activite-modifier')
                                                    <a href="{{ route('activites.edit', $activite->id) }}" class="btn btn-sm bg-danger-light student_delete">
