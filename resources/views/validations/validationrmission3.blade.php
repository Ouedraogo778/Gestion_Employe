        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-header text-center" style="background-color:blue;">
                    <h3 style="font-family:'Times New Roman', Times, serif; font-weight: bold; color:chartreuse; text-shadow: 4px 4px 6px rgba(0, 0, 0, 0.9);" >Validation du rapport de mission</h3>
                </div>
                    <div class="card-body">
                            ...
                            <table id="" class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <thead class="student-thread" id="entete">
                                    <tr>
                                        ...
                                        <th style="font-size: 18px; ">Rapport de mission</th>
                                        ...
                                        <th style="font-size: 18px; width: 200px;">Validation supperieur</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody id="Table">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 16px; color: black;">{{ $rmission->activite_id }}
                                        </td>
                                        ...
                                        <td style="font-size: 16px; color: black;">
                                            <div class="action">
                                                <form action="{{ url('/validationrmission3', $rmission->id) }}" method="POST" class="actions">
                                                    @csrf
                                                    @method('POST')
                                                    <button type="submit" class="badge badge-success">Valider</button>
                                                </form>
                                                <form action="{{ url('/rejetrmission3', $rmission->id) }}" method="POST" class="actions">
                                                    @csrf
                                                    <div>
