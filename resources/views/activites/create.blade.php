            ...
            <div class="col-sm-12">
                <div class="card-body">
                    ...
                    <div class="container mt-5 d-flex justify-content-center">
                        <div class="card card-width w-85">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('activites.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation">
                                            @csrf
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <select name="employe_id" class="form-control select" id="" required>
                                                        ...
                                                        <option value="{{$listeemploye->id}}">{{$listeemploye->nom_prenom}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    <label for="nom" class="form-label">Nom de l'activité<span class="login-danger">*</span></label>
                                                    <input type="text" class="form-control" name="nom" placeholder="nom" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Objectif de l'activité<span class="login-danger">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">TDR<span class="login-danger">*</span></label>
                                                    <input type="file" name="pdf_file1" class=" form-control" accept=".pdf, .docx, .xls, .xlsx" required>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Expression de besoin <span class="login-danger">*</span></label>
                                                    <input type="file" name="pdf_file2" class=" form-control " accept=".pdf, .docx, .xls, .xlsx" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <textarea class="form-control" name="description" id="" cols="" rows=""></textarea>
