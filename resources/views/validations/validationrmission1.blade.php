                            ...
                            <table id="" class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <tbody id="Table">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 16px; color: black;">
                                            {{ $rmission->validation_finance }}
                                        </td>
                                        
                                       
                                        <td style="font-size: 16px; color: black;">
                                            <div class="action">
                                                <form action="{{ url('/validationrmission1', $rmission->id) }}" method="POST" class="actions">
                                                    @csrf
                                                    @method('POST')
                                                    <button type="submit" class="badge badge-success">Valider</button>
                                                </form>
                                                <form action="{{ url('/rejetrmission1', $rmission->id) }}" method="POST" class="actions">
                                                    @csrf
                                                    <div>
