                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4" style="font-size: 22px;">
                            ...
                            <br>
                            <div class="form-group local-forms">
                                <strong style="color: red"><u>Code de la mission: </u></strong>
                                {{ $rmission->mission_id}}
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12" style="font-size: 22px;">
                            <div class="form-group local-forms">
                                <strong style="color: rgb(0, 0, 0)"><u>LISTE DE PRESENCE</u>:</strong>
                                @if ($rmission->pdf_rmission)
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12" style="font-size: 22px;">
                            <div class="form-group local-forms">
                                <strong style="color: rgb(0, 0, 0)"><u>RAPPORT FINANCIER</u>:</strong>
