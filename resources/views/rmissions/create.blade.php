...
<div class="page-wrapper">
                    ...
                    <div class="container mt-5 d-flex justify-content-center">
                        <div class="card card-width w-75">
                            <div class="card-header text-center" style="background-color:blue;">
                                <h3 style="font-family:'Times New Roman', Times, serif; font-weight: bold; color:chartreuse; text-shadow: 4px 4px 6px rgba(0, 0, 0, 0.9);" >Ajouter un rapport de mission</h3>
                            </div>
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('rmissions.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation">
                                        @csrf
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Code mission<span class="login-danger">*</span></label>
                                                <select name="mission_id" class="form-control select" id="mission_id" required>
                                                    <option selected disabled>Choisir la mission</option>
                                                    @foreach($listemissions as $listemission)
                                                    <option value="{{$listemission->code}}">
                                                        {{$listemission->code}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Rapport narratif<span class="login-danger">*</span></label>
                                        ...
                                        <div class="row">
                                        <div class="mb-3 col-md-6">
                                                <label class="form-label">Liste de présence<span class="login-danger">*</span></label>
                                                <input type="file" name="pdf_file2" class="form-control" accept=".pdf, .docx, .xls, .xlsx" />
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Rapport financier<span class="login-danger">*</span></label>
                                                <input type="file" name="pdf_file3" class="form-control" accept=".pdf, .docx, .xls, .xlsx" />
                                            </div>
                                        </div>
    ...
    $(document).ready(function () {
        ...
        $('#mission_id').change(function () {
            ...
            var codeMission = $(this).val();

            // Effectuer une requête AJAX pour obtenir le nom de l'employé et le code du projet associés
            $.ajax({
                type: 'GET',
                url: '/getNomEmployes/' + codeMission, // Remplacez avec votre route et contrôleur appropriés
