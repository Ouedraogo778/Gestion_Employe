            ...
            <div class="col-sm-12">
                <div class="card card-table comman-shadow">
                    <div class="card-header text-center" style="background-color:blue;">
                        <h3 style="font-family:'Times New Roman', Times, serif; font-weight: bold; color:chartreuse; text-shadow: 4px 4px 6px rgba(0, 0, 0, 0.9);">Liste des rapports d'activité en retard</h3>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="example1" class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                            ...
                            <tbody id="Table">
                                ...
                                @foreach ($retardactivites as $retardactivite)
                                <tr>

                                    <td style="font-size: 16px; color: black;">{{ ++$i }}</td>

                                    <td style="font-size: 16px; color: black; ">{{ $retardactivite->projet_id }}</td>
                                    <td style="font-size: 16px; color: black;">{{ $retardactivite->employe_id }}</td>
                                    <td style="font-size: 16px; color: black;">{{ $retardactivite->activite_id }}
                                    </td>
                                    <td style="font-size: 16px; color: black;">{{ $retardactivite->nom_activite }}
                                    </td>
                   ...
                   <div id="pagination">{!! $retardactivites->links() !!}</div>  
