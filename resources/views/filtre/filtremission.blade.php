        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-header text-center" style="background-color:blue;">
                                    <h3 style="font-family:'Times New Roman', Times, serif; font-weight: bold; color:chartreuse; text-shadow: 4px 4px 6px rgba(0, 0, 0, 0.9);" >Liste des mission</h3>
                                </div>
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    ...
                                    @can('mission-ajouter')
                                    <a href="{{ route('missions.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Ajouter une mission</a>
                                    @endcan
