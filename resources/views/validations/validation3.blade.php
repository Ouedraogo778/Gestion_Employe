                            ...
                            <table id="" class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <thead class="student-thread" id="entete">
                                    <tr>
                                        ...
                                        <th style="font-size: 18px; width: 200px;">Validation niveau supperieur</th>
                                ...
                                <tbody id="Table">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 16px; color: black;">
                                            <div class="action">
                                                <form action="{{ url('/validation3', $activite->id) }}" method="POST" class="actions">
                                                    @csrf
                                                    @method('POST')
                                                    <button type="submit" class="badge badge-success">Valider</button>
                                                </form>
                                                <form action="{{ url('/rejet3', $activite->id) }}" method="POST" class="actions">
                                                    @csrf
                                                    <div>
